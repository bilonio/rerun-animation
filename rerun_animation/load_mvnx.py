...
import collections
import numpy as np
from rerun_animation.mvnx_file_accessor import MvnxFileAccessor
...
def parse_sensor(sensors_element, segment_names):
    ...
    :param sensors_element: The sensor element to parse
...
def get_sensor_data_from_frame(frame_element, sensor_names):
    ...
    for index in range(len(sensor_names)):
        ...
        sensor_data[sensor_name]["mag"] = get_3d_vector(magnetic_field, index)
