...
# Sensors 
SENSORS = {
    SEGMENT_PELVIS: 'S_Pelvis',
    SEGMENT_T8: 'S_T8',
    SEGMENT_HEAD: 'S_Head',
    SEGMENT_RIGHT_SHOULDER: 'S_RightShoulder',
    SEGMENT_RIGHT_UPPER_ARM: 'S_RightUpperArm',
    SEGMENT_RIGHT_FOREARM: 'S_RightForeArm',
    SEGMENT_RIGHT_HAND: 'S_RightHand',
    SEGMENT_LEFT_SHOULDER: 'S_LeftShoulder',
    SEGMENT_LEFT_UPPER_ARM: 'S_LeftUpperArm',
    SEGMENT_LEFT_FOREARM: 'S_LeftForeArm',
    SEGMENT_LEFT_HAND: 'S_LeftHand',
    SEGMENT_RIGHT_UPPER_LEG: 'S_RightUpperLeg',
    SEGMENT_RIGHT_LOWER_LEG: 'S_RightLowerLeg',
    SEGMENT_RIGHT_FOOT: 'S_RightFoot',
    SEGMENT_LEFT_UPPER_LEG: 'S_LeftUpperLeg',
    SEGMENT_LEFT_LOWER_LEG: 'S_LeftLowerLeg',
    SEGMENT_LEFT_FOOT: 'S_LeftFoot',
}

def get_sensor_config(body_type="full_body_no_hands"):
    # Define which segments we want to exclude for each type
    exclude = {
        "full_body_no_hands": ["S_RightHand", "S_LeftHand"],
        "upper_body": ["S_RightUpperLeg", "S_RightLowerLeg", "S_RightFoot", "S_LeftUpperLeg", "S_LeftLowerLeg", "S_LeftFoot"],
        "lower_body": ["S_Head", "S_RightShoulder", "S_RightForeArm", "S_RightUpperArm", "S_LeftShoulder", "S_LeftForeArm", "S_LeftUpperArm", "S_T8", "S_RightHand", "S_LeftHand"],
        "upper_body_no_hands": ["S_RightUpperLeg", "S_RightLowerLeg", "S_RightFoot", "S_LeftUpperLeg", "S_LeftLowerLeg", "S_LeftFoot", "S_RightHand", "S_LeftHand"],
        "lower_body_sternum": ["S_Head", "S_RightShoulder", "S_RightForeArm", "S_RightUpperArm", "S_LeftShoulder", "S_LeftForeArm", "S_LeftUpperArm", "S_RightHand", "S_LeftHand"],
        "full_body": []
    }
    
    active_exclude = exclude.get(body_type, [])
    
    # Generate the SENSORS dict: { index_in_mvnx: "Sensor_Name" }
    sensors = {}
    for seg_idx, name in (SENSORS.items()):
        if name not in active_exclude:
            sensors[seg_idx] = name
